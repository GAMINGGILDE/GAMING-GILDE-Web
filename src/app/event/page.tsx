            ...
            <div className="px-10 mt-36">
                <div className="relative block text-white text-center">
                    <div className="flex flex-row justify-center m-0 p-0 gap-x-10 uppercase">
                        <h1 className="text-6xl sm:text-9xl lg:text-[10rem] font-bold tracking-widest m-0 leading-none">Neues</h1>
                        <h1
                            className="text-6xl linear-text sm:text-9xl lg:text-[10rem] font-bold tracking-widest m-0 leading-none"
