...
export const Headline = (props: HeadlineInterface) => {
    return (
        <div className="mt-60 px-3 lg:px-0 text-center w-full m-auto lg:w-[75%]">
            ...
            {props.preTitle && (
                <p className="w-full mb-0 m-auto lg:w-[75%] text-white tracking-wider font-semibold uppercase text-md lg:text-xl wrap-break-word">{props.preTitle}</p>
            )}
            ...
            <div className="mt-2 lg:mt-2">
                ...
                <p className="w-full mb-7 m-auto lg:w-[75%] sub-text mt-7 font-light text-md lg:text-2xl wrap-break-word">{props.text}</p>
