        ...
        <div className="my-24">
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between flex-wrap font-extralight text-xs">
            ...
            <div className="mt-3 lg:mt-0 flex justify-center items-center lg:flex-1">
              <div className="mx-2">
                <a href="https://discord.gaming-gilde.org" title="Discord" target="_blank">
                  <FaDiscord className="w-5 h-5 text-white hover:text-primary" />
                </a>
              </div>

              <div className="mx-2">
                <a href="https://www.tiktok.com/@gaminggilde" title="TikTok" target="_blank">
                  <FaTiktok className="w-5 h-5 text-white hover:text-primary" />
                </a>
              </div>

              <div className="mx-2">
                <a href="https://www.twitch.tv/gaming_gilde" title="Twitch" target="_blank">
                  <FaTwitch className="w-5 h-5 text-white hover:text-primary" />
                </a>
              </div>

              <div className="mx-2">
                <a href="https://www.youtube.com/@Gaming-Gilde" title="YouTube" target="_blank">
                  <FaYoutube className="w-5 h-5 text-white hover:text-primary" />
                </a>
              </div>

              <div className="mx-2">
                <a href="https://github.com/GAMINGGILDE" title="GitHub" target="_blank">
            ...
            <div className="mt-3 lg:mt-0 lg:flex-1 text-center lg:text-right">
              <a href="/impressum/" title="Impressum" className="mr-4 hover:text-primary">
                Impressum{" "}
              </a>

              <a href="/datenschutz/" title="Datenschutzerklärung" className="hover:text-primary">
                Datenschutz{" "}
              </a>
            </div>
          </div>
