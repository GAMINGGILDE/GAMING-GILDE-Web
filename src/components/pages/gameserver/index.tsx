                    ...
                    >
                        <>
                            ...
                            <p className="text-base leading-relaxed text-gray-500">
                                ...
                                <a className="text-primary hover:underline" href="https://www.curseforge.com/hytale/mods/essentials-core" target="_blank">Essentials Core</a>, <a className="text-primary hover:underline" href="https://www.curseforge.com/hytale/mods/bettermap" target="_blank"> BetterMap</a>, <a className="text-primary hover:underline" href="https://www.curseforge.com/hytale/mods/gravestones" target="_blank">Gravestones</a>, <a className="text-primary hover:underline" href="https://www.curseforge.com/hytale/mods/luckperms" target="_blank"> LuckPerms</a>, <a className="text-primary hover:underline" href="https://www.curseforge.com/hytale/mods/no-teleporters-limit" target="_blank"> Extended Teleporters</a>, <a className="text-primary hover:underline" href="https://www.curseforge.com/hytale/mods/simple-claims" target="_blank"> Simple Claims</a>, <a className="text-primary hover:underline" href="https://www.curseforge.com/hytale/mods/repair-anvil" target="_blank"> Repair Anvil</a>, <a className="text-primary hover:underline" href="https://www.curseforge.com/hytale/mods/hytame" target="_blank"> HyTame - Animal Breeding</a>, <a className="text-primary hover:underline" href="https://www.curseforge.com/hytale/mods/miners-helmet" target="_blank"> Miners Helmet</a>, <a className="text-primary hover:underline" href="https://www.curseforge.com/hytale/mods/chestrangemod" target="_blank"> ChestRangeMod</a>.
                            </p>
