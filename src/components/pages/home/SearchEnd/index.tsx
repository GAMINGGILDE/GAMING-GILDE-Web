            ...
            <div className="grid grid-cols-12 items-center lg:gap-x-10">
                <div className="col-span-12 lg:col-span-8 mb-3">
                    ...
                    <p className="text-white font-thin mt-4 mb-7">
                        ...
                        austauschen. Wir bieten kostenfrei unsere Lifetime Gameserver für Satisfactory, Minecraft und Core Keeper an,
                        ...
                        <br/><br/>
                        Wir sind immer auf der Suche nach neuen Spielkammeraden*innen.<br/>
