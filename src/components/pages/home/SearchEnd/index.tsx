            ...
            <div className="grid grid-cols-12 items-center lg:gap-x-10">
                <div className="col-span-12 lg:col-span-8 mb-3">
                    ...
                    <p className="text-white font-thin mt-4 mb-7">
                        ...
                        <br/><br/>
                        Zudem kannst du durch uns <a href="https://zap-hosting.com/anticoronakartellbanner">20% Rabatt</a> auf einen eigenen Gameserver bei unserm Hoster <a href="https://zap-hosting.com/anticoronakartellbanner">Zap-Hosting</a> bekommen. Wenn du
