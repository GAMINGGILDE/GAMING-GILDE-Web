...
export const History = () => {
    return (
        <div>
            ...
            <div className="px-10 xl:px-0 mt-32 max-w-[1280px] mx-auto">
                ...
                <div className="my-20 text-white tracking-wider w-[100%] m-auto">
                    ...
                    <p className="text-lg mb-5">
                        Zu einigen Events haben wir ein paar Videos auf unserem <a className="text-primary hover:underline" href="https://www.youtube.com/@Anti-Corona-Kartell" target="_blank">YouTube-Kanal</a> veröffentlicht. Schau
