    ...
    return(
        <div className="my-20 text-white w-[100%] m-auto">
            ...
            <p className="text-base lg:text-lg mb-0">
                <strong><a className="text-primary hover:underline" href="https://youtu.be/WxAkHRlCObw?si=1lvA7uV_Lf4XYVh1" target="_blank">RETRO, Kult, Legende, Mythos</a></strong>
            </p>
            <p className="sub-text font-light mb-4">
                In den vergangenen Jahren gab es keinen Event der mehr als alle anderen Veranstaltungen für mehr Furore gesorgt haben als unsere RETRO-Events im Kino. Sie sind Kult und Legende. Damit sie nicht zum Mythos werden, ließen wir ihn einmal mehr aufleben.
            </p>
